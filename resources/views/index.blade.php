    ...
    <div class="b1">
        <div class="container">
            ...
            <div class="row mt-5 justify-content-center">
                <div class="c c1 col-6 col-sm-4 col-md-3 col-lg-2">
                    <div class="box">
                        ...
                        <div class="deskripsi">
                            ...
                            <div class="text">Angkatan 3</div>
                            <div class="text">Jurusan IT</div>
                        </div>
                        <div class="tombol">
                            <button type="button" class="btn btn-outline-dark">Lihat Profil</button>
                        </div>
                    </div>
                </div>
                <div class="c c2 col-6 col-sm-4 col-md-3 col-lg-2">
                    <div class="box">
                        <div class="gambar">
                            <img src="img/logo/dummy.jpg" alt="Picture">
                        </div>
                ...
                <div class="c c3 col-6 col-sm-4 col-md-3 col-lg-2">
                    <div class="box">
                        <div class="gambar">
                            <img src="img/logo/dummy.jpg" alt="Picture">
                        </div>
                ...
                <div class="c c4 col-6 col-sm-4 col-md-3 col-lg-2">
                    <div class="box">
                        <div class="gambar">
                            <img src="img/logo/dummy.jpg" alt="Picture">
                        </div>
                ...
                <div class="c c5 col-6 col-sm-4 col-md-3 col-lg-2">
                    <div class="box">
                        <div class="gambar">
                            <img src="img/logo/dummy.jpg" alt="Picture">
                        </div>
                        <div class="deskripsi">
                            <div class="text">Lana Saiful Aqil</div>
                            <div class="text">Angkatan 3</div>
                            <div class="text">Jurusan IT</div>
                        </div>
                        <div class="tombol">
